...
1. Erstellt in 2er- oder 3er-Teams **eine Skizze**, die zeigt, wie ein Programm
   von der Eingabe in einer IDE bis zur Ausführung in der CPU und Speicherung
   von Variablen im Speicher funktioniert.
...
4. Erklärt die Begriffe kurz in euren **eigenen Worten** direkt in der Zeichnung
   oder in einem kleinen Begleittext.

5. Erstellt ein Foto oder einen Screenshot und ladet die Zeichnung (Nachnamen im
   Dateinamen verwenden) in Teams.
